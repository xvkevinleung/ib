...
func init() {
	...
	REQUEST.CODE.ACCOUNT_UPDATES = 6
	...
	REQUEST.CODE.ACCOUNT_SUMMARY = 62
	REQUEST.CODE.POSITIONS = 61
	...
	REQUEST.VERSION.ACCOUNT_UPDATES = 2
	...
	REQUEST.VERSION.ACCOUNT_SUMMARY = 1
}
